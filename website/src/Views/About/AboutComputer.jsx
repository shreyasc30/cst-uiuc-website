...
// didn't need this for ._about, so a little confused
// scss seemed to have just loaded automatically somehow?
import './_aboutcomputer.scss';
...
function AboutComputer() {
    ...
    return (
        <>
            <Navigation />
            <div className="AboutComputer">
                <div className="container">
                    
                    <div className="about-us">
                        <h1>About Us</h1>

                        <div className="split-img-p">
                            <p>
